...
<head>
  ...
  <link rel="stylesheet" href="https://github.com/twbs/bootstrap/blob/master/dist/css/bootstrap.min.css">
</head>
<body ontouchstart="">
...
<script>
  ...
  function initPage() {
    $.post("http://www.tribeofspirit.com/wxConfig?_method=get",{"url":window.location.href},function(data,status){
      wx.config(data);
      /*
       wx.ready(function(){
  ...
  /*
   wx.config({
   debug: false,
   appId: 'wxadda3fceffbc48d3',
   timestamp: 1421142450,
   nonceStr: '9hKgyCLgGZOgQmEI',
   signature: 'f99bf60c6dd87caa28a132754d11b947',
   jsApiList: [
   'checkJsApi',
   'onMenuShareTimeline',
...
<script src="js/demo.js?ver=1.0.2"> </script>
</html>